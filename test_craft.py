...
if __name__ == '__main__':
    ...
    # print("Preparing to load images: "+str(image_list))
    # load data
    for k, image_path in enumerate(image_list):
        ...
        padded_image = np.zeros((image.shape[0] + 2 * padding_size, image.shape[1] + 2 * padding_size, 3),
                                dtype=np.uint8)
        ...
        res_img_corr_new_file = "./result/" + "res_corr_new_" + filename + '.jpg'
...
#             box_vertices = np.int0(box_vertices)
            box_vertices = np.intp(box_vertices)
        ...
        if angled_rois:
            ...
            if angle != 90:
                ...
                cv2.imwrite(res_img_corr_new_file, img_new)

                text_line = pytesseract.image_to_string(img_new, lang='eng')
                print("Image to text: \n\n" + text_line)
                print("==================================")



        # print("Saving result " + mask_file)
